 ...
 *      parameters:
 *        - in: body
 *          description: truyền vô list user, group_name và admin_id
 *          schema:
 *            properties:
 *              user_id:
 *                type: array
 ...
 *                },
 *                "requests": [],
 *                "admin": "635d3cee5bce0759e40f59a4",
 *                "last_message": "636891ac43bb4ddebabe10f6",
 *                "is_group": true,
 *                "seen_last_messages": false,
 ...
 *  /conversaion/group:
 *    post:
 *      summary: lấy danh sách group theo user_id
 *      tags: [Conversation]
 *      consumes:
 *        - application/json
 *      parameters:
 *        - in: body
 *          description: truyền vô user_id
 *          schema:
 *            properties:
 *              user_id:
 *                type: string
 ...
 *                    "seen_last_messages": false,
 *                    "last_message": {
 *                      "_id": "636690c604659016450dcf9a",
 *                      "content": "Tin nhắn đã được thu hồi",
 *                      "content_type": "recover",
 *                      "deleted": true,
 *                      "createdAt": "2022-11-05T16:35:18.179Z"
 *                    },
 *                    "createdAt": "2022-10-29T07:12:10.710Z",
 *                    "updatedAt": "2022-11-05T16:35:18.228Z",
 *                    "receiver": {
 *                      "_id": "635cd24af94a4a2396c4ecb5",
 *                      "nick_name": "Quang, Nam,...",
 *                      "avatar": "data:image/png;base64,"
 *                    }
 *                  },
...
/**
 *  @swagger
 *  /conversaion/give-admin:
 *    post:
 *      summary: truyền chức admin
 *      tags: [Conversation]
 *      consumes:
 *        - application/json
 *      parameters:
 *        - in: body
 *          description: truyền vô user_id, conversation_id và admin_id
 *          schema:
 *            properties:
 *              user_id:
 *                type: string
